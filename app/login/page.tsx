...
export default function LoginPage() {
  ...
  return (
    <main className="animate-blur-in min-h-screen flex flex-col items-center justify-center bg-canvas px-6 py-10">
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img
        src="/logo.png"
        alt="Artiestenportaal.nl"
        className="w-[85vw] max-w-[567px] h-auto mb-2"
      />
      <p className="text-muted text-[13px] mb-8">Log in om je overzicht te zien</p>
