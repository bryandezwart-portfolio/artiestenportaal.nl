  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-canvas px-6">
      <div className="w-full max-w-sm">
        ...
        >
          <div>
            <label className="text-[11.5px] font-medium text-muted mb-1.5 block">E-mail</label>
            <input
              type="email"
              required
              value={email}
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-2 w-full bg-accent text-white text-[13.5px] font-medium rounded-lg py-2.5 shadow-sm hover:bg-accent/90 hover:shadow active:scale-[0.98] transition disabled:opacity-50"
          >
